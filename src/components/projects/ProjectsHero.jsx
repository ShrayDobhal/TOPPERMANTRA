        ...
        >
          <motion.div variants={fadeUp} className="mb-6">
            <span className="inline-block py-1.5 px-4 rounded-full bg-slate-100 text-slate-600 font-semibold text-sm border border-slate-200">
              India's Largest Student Builder Ecosystem
            </span>
          </motion.div>
          ...
          >
            Work on real-world projects with students, mentors, startups, and researchers. Build your portfolio while solving meaningful problems.
          </motion.p>
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button 
              variant="primary" 
              size="lg" 
              className="w-full sm:w-auto px-8 shadow-[0_4px_14px_0_rgba(255,87,34,0.39)] hover:shadow-[0_6px_20px_rgba(255,87,34,0.23)] hover:scale-105 transition-all flex items-center gap-2"
              onClick={() => document.getElementById('project-search')?.scrollIntoView({ behavior: 'smooth' })}
            >
